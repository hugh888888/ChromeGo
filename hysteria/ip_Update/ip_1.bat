...
cd /d %~dp0
..\..\wget -t 5 --no-check-certificate https://gitlab.com/free9999/ipupdate/-/raw/master/hysteria/config.json

if exist config.json goto startcopy

..\..\wget -t 5 --no-check-certificate https://www.githubip.xyz/Alvin9999/pac2/master/hysteria/1/config.json
