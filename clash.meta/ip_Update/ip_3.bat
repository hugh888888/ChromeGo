...
cd /d %~dp0
..\..\wget -t 5 --no-check-certificate https://gitlab.com/free9999/ipupdate/-/raw/master/clash.meta/2/config.yaml

if exist config.yaml goto startcopy

..\..\wget -t 5 --no-check-certificate https://www.githubip.xyz/Alvin9999/pac2/master/clash.meta/13/config.yaml
