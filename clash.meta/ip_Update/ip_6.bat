...
cd /d %~dp0
..\..\wget -t 5 --no-check-certificate https://www.githubip.xyz/Alvin9999/pac2/master/clash.meta/3/config.yaml

if exist config.yaml goto startcopy

..\..\wget -t 5 --no-check-certificate https://fastly.jsdelivr.net/gh/Alvin9999/pac2@latest/clash.meta/3/config.yaml
